...
export function AccountsNeedingAttention({
  ...
  return (
    <div className="border" style={{ backgroundColor: '#1A1A1C', borderColor: '#2A2A2C' }}>
      <div className="p-6 border-b" style={{ borderColor: '#2A2A2C', backgroundColor: '#1F1619' }}>
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2" style={{ backgroundColor: '#4d1a2e' }}>
            <AlertCircle className="w-5 h-5" style={{ color: '#FF0067' }} />
          </div>
          <h3 style={{ color: '#E5E5E5' }}>Accounts Needing Attention</h3>
        </div>
      ...
      <div className="overflow-x-auto">
        <Table>
          ...
          <TableBody>
            {accounts.length === 0 ? (
              <TableRow>
                <TableCell colSpan={5} className="text-center" style={{ color: '#B8B8B8' }}>
