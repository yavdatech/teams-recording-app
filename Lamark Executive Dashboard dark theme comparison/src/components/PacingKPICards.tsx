  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div 
        ...
        style={{ backgroundColor: '#1A1A1C', borderLeftColor: '#1D5BEB', borderTop: '1px solid #2A2A2C', borderRight: '1px solid #2A2A2C', borderBottom: '1px solid #2A2A2C' }}
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs uppercase tracking-wide" style={{ color: '#B8B8B8' }}>Spend Pacing</span>
          <div className="p-2" style={{ backgroundColor: '#1A2433' }}>
            <Target className="w-5 h-5" style={{ color: '#1D5BEB' }} />
          </div>
        </div>
        <div className="mb-3 text-3xl" style={{ color: '#E5E5E5' }}>
      ...
      <div 
        className="p-7 border-l-4 relative" 
        style={{ backgroundColor: '#1A1A1C', borderLeftColor: '#4A7CEF', borderTop: '1px solid #2A2A2C', borderRight: '1px solid #2A2A2C', borderBottom: '1px solid #2A2A2C' }}
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs uppercase tracking-wide" style={{ color: '#B8B8B8' }}>ROAS Performance</span>
          <div className="p-2" style={{ backgroundColor: '#1A2433' }}>
            <Target className="w-5 h-5" style={{ color: '#1D5BEB' }} />
          </div>
        </div>
      ...
      <div 
        className="p-7 border-l-4 relative" 
        style={{ backgroundColor: '#1A1A1C', borderLeftColor: '#4ade80', borderTop: '1px solid #2A2A2C', borderRight: '1px solid #2A2A2C', borderBottom: '1px solid #2A2A2C' }}
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs uppercase tracking-wide" style={{ color: '#B8B8B8' }}>On Track</span>
        ...
        <div className="flex items-center gap-1 text-sm" style={{ color: '#B8B8B8' }}>
          <span>
      ...
      <div 
        className="p-7 border-l-4 relative" 
        style={{ backgroundColor: '#1A1A1C', borderLeftColor: '#FF0067', borderTop: '1px solid #2A2A2C', borderRight: '1px solid #2A2A2C', borderBottom: '1px solid #2A2A2C' }}
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs uppercase tracking-wide" style={{ color: '#B8B8B8' }}>Needs Attention</span>
