...
export function PacingDashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#0A0A0B' }}>
      {/* Page Header */}
      <div className="border-b" style={{ backgroundColor: '#141416', borderColor: '#2A2A2C' }}>
        <div className="px-10 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="mb-1" style={{ color: '#E5E5E5' }}>Pacing Dashboard</h1>
            ...
            <div className="flex items-center gap-2 px-4 py-2 border" style={{ borderColor: '#2A2A2C', backgroundColor: '#1A1A1C' }}>
              <div className="w-2 h-2" style={{ backgroundColor: '#4ade80' }}></div>
              <div className="text-sm" style={{ color: '#B8B8B8' }}>
                <span style={{ color: '#E5E5E5' }}>Last Updated:</span> Nov 18, 2024 • 2:45 PM
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-10">
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              <h2 className="mb-3" style={{ color: '#E5E5E5' }}>Executive Summary</h2>
            ...
            <div className="flex gap-2">
              <div className="px-4 py-2 border" style={{ backgroundColor: '#1A1A1C', borderColor: '#2A2A2C' }}>
                <div className="text-xs uppercase tracking-wide mb-1" style={{ color: '#B8B8B8' }}>Portfolio Health</div>
