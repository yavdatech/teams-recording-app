...
import { SegmentMigrationFlow } from "./components/SegmentMigrationFlow";
import { CohortAnalysis } from "./components/CohortAnalysis";
import { PredictiveAnalytics } from "./components/PredictiveAnalytics";
import { CampaignImpactTracker } from "./components/CampaignImpactTracker";
import { CustomerJourney } from "./components/CustomerJourney";
import { ComparativeAnalysis } from "./components/ComparativeAnalysis";
import { RevenueWaterfall } from "./components/RevenueWaterfall";
import { ProductAffinity } from "./components/ProductAffinity";
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-gray-900">RFM Analytics Dashboard Pro</h1>
              <p className="text-sm text-gray-600 mt-1">
                Advanced customer intelligence with predictive analytics, cohort analysis, and engagement tracking
              </p>
            </div>
