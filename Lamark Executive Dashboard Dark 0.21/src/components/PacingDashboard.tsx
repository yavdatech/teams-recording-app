      ...
      <div className="bg-white border-b" style={{ borderColor: '#DDDDDE' }}>
        <div className="px-10 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="mb-1" style={{ color: '#53565A' }}>Pacing Dashboard</h1>
            ...
            <div className="flex items-center gap-2 px-4 py-2 border" style={{ borderColor: '#DDDDDE', backgroundColor: '#FAFBFC' }}>
              ...
              <div className="text-sm" style={{ color: '#75787B' }}>
                <span style={{ color: '#53565A' }}>Last Updated:</span> Nov 18, 2024 • 2:45 PM
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-10">
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              <h2 className="mb-3" style={{ color: '#53565A' }}>Executive Summary</h2>
              <p className="text-sm max-w-3xl" style={{ color: '#75787B' }}>
            ...
            <div className="flex gap-2">
              <div className="px-4 py-2 bg-white border" style={{ borderColor: '#DDDDDE' }}>
                <div className="text-xs uppercase tracking-wide mb-1" style={{ color: '#75787B' }}>Portfolio Health</div>
