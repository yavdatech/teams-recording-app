...
export function ChannelPerformance({ data }: ChannelPerformanceProps) {
  ...
  return (
    <div className="bg-white p-7 border" style={{ borderColor: '#DDDDDE' }}>
      <div className="mb-6">
        <h3 className="mb-2" style={{ color: '#53565A' }}>Channel Performance Breakdown</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-4" style={{ backgroundColor: '#FAFBFC' }}>
          <h4 className="mb-4" style={{ color: '#53565A' }}>ROAS Performance by Channel</h4>
          <ResponsiveContainer width="100%" height={280}>
            <ComposedChart data={data}>
              <CartesianGrid strokeDasharray="3 3" stroke="#DDDDDE" />
              <XAxis dataKey="channel" stroke="#75787B" tick={{ fill: '#75787B', fontSize: 11 }} />
              <YAxis stroke="#75787B" tick={{ fill: '#75787B', fontSize: 11 }} />
              <Tooltip
                contentStyle={{
                  backgroundColor: "#fff",
              ...
              <Line 
                ...
                stroke="transparent"
                strokeWidth={0}
                dot={{ fill: '#53565A', r: 5, strokeWidth: 2, stroke: '#fff' }}
                name="Target ROAS" 
              />
            </ComposedChart>
          </ResponsiveContainer>
        ...
        <div className="p-4" style={{ backgroundColor: '#FAFBFC' }}>
          <h4 className="mb-4" style={{ color: '#53565A' }}>Spend Performance by Channel</h4>
          <ResponsiveContainer width="100%" height={280}>
            <ComposedChart data={data}>
              <CartesianGrid strokeDasharray="3 3" stroke="#DDDDDE" />
              <XAxis dataKey="channel" stroke="#75787B" tick={{ fill: '#75787B', fontSize: 11 }} />
