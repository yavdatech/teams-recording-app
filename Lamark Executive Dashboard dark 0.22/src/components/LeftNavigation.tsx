...
export function LeftNavigation({ activeView, onViewChange }: LeftNavigationProps) {
  return (
    ...
    >
      {/* Logo Area */}
      <div className="p-6 border-b" style={{ borderColor: '#2A2C30' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs" style={{ color: '#CCCCCC' }}>Analytics Platform</div>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Navigation */}
      <div className="border-t p-3" style={{ borderColor: '#2A2C30' }}>
        <nav className="space-y-1">
        ...
        {/* User Info */}
        <div className="mt-4 pt-4 border-t" style={{ borderColor: '#2A2C30' }}>
          <div className="flex items-center gap-2 px-3">
            ...
            <div className="flex-1">
              <div className="text-sm" style={{ color: '#E6EDF3' }}>John Doe</div>
              <div className="text-xs" style={{ color: '#CCCCCC' }}>Admin</div>
            </div>
          </div>
        </div>
      </div>
